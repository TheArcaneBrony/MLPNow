...
<?  } ?>
			<p><a class="dyn" href="https://github.com/SeinopSys/MLPNow" target="_blank">MLP Now</a> <a class="dyn" href="https://github.com/SeinopSys/MLPNow/commit/<?=LATEST_COMMIT_ID?>" target="_blank"><?=array_keys($updates)[0].'.0.'.LATEST_COMMIT_ID?></a> - <a id="credits" class="dyn">Credits</a></p>
		</div>
	</div>
</div>
